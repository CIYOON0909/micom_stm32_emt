...
#define MCU_EN_AON_Pin                   	    GPIO_PIN_1
#define MCU_EN_AON_GPIO_Port            	   	GPIOA
...
#define GPIOA_DEFAULT_PINSET					MCU_EN_MCUPWR_Pin|MCU_EN_EDLC_Pin|MCU_EN0V9_1V8_DCDC_Pin|MCU_EN_AON_Pin
