...
#ifndef __EMT_IO_CYCLOPS_H__
#define __EMT_IO_CYCLOPS_H__
...
#define USB_DET_MCU_Pin                       	GPIO_PIN_4	/* */
#define USB_DET_MCU_GPIO_Port                 	GPIOA
#define BP_ADC_MCU_Pin                          GPIO_PIN_3	/* BP12_ADC_MCU */
...
#define MCU_EN3V0_DCDC_Pin                  	GPIO_PIN_6	/* */
...
#define MCU_EN_BLED_Pin                        	GPIO_PIN_14	/* */
#define MCU_EN_BLED_GPIO_Port                  	GPIOA

#define MCU_EN_WLED_Pin                        	GPIO_PIN_13	/* */
#define MCU_EN_WLED_GPIO_Port                  	GPIOA
#define MCU_EN_EDLC_Pin                  	   	GPIO_PIN_4	/* */
#define MCU_EN_EDLC_GPIO_Port           	    GPIOB
#define MCU_PWR_RCAM_Pin                        GPIO_PIN_3	/* MCU_5V0EN_TVI */
...
#define MCU_EN_CPU_GPIO_Port	               	GPIOA
#define MCU_EN1V5_DCDC_Pin	                    GPIO_PIN_7	/* */
...
#define BP24_ADC_MCU_Pin                        GPIO_PIN_1	/* BP24_ADC_MCU */
#define BP24_ADC_MCU_GPIO_Port                  GPIOB
...
#define GPIOA_DEFAULT_PINSET					MCU_EN_MCUPWR_Pin|MCU_EN0V9_1V8_DCDC_Pin|MCU_EN_CPU_Pin
#else
#define GPIOA_DEFAULT_PINSET					MCU_EN_MCUPWR_Pin|MCU_EN0V9_1V8_DCDC_Pin|MCU_EN_CPU_Pin|MCU_EN_WLED_Pin|MCU_EN_BLED_Pin
#endif
#define GPIOB_DEFAULT_PINSET					MCU_AQS0_CPU_Pin|MCU_AQS1_CPU_Pin|MCU_AQS2_CPU_Pin|MCU_EN_EDLC_Pin|MCU_PWR_RCAM_Pin|MCU_EN1V5_DCDC_Pin|MCU_EN3V0_DCDC_Pin
...
#define ADC_IN_B_PORT_PINS						BP24_ADC_MCU_Pin
