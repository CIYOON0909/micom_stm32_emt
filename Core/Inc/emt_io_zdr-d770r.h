...
#ifndef __EMT_IO_ZDR_D770R_H__
#define __EMT_IO_ZDR_D770R_H__
...
#define PMIC_PG_MCU_Pin							GPIO_PIN_1
#define PMIC_PG_MCU_GPIO_Port					GPIOB
...
#else
#define MCU_SCL1_GSEN_Pin                      	GPIO_PIN_9
#define MCU_SCL1_GSEN_GPIO_Port                	GPIOA
#define MCU_SDA1_GSEN_Pin                      	GPIO_PIN_10
#define MCU_SDA1_GSEN_GPIO_Port                	GPIOA
#endif
...
#define GPIOA_DEFAULT_PINSET					MCU_EN_PMIC_Pin|MCU_EN_MCUPWR_Pin|MCU_EN_EDLC_Pin/*PMIC_PG_MCU_Pin MCU_EN_GLED_Pin  MCU_EN_RLED_Pin*/
#define GPIOB_DEFAULT_PINSET					MCU_PWR_RCAM_Pin|MCU_AQS0_CPU_Pin|MCU_EN_CPU_Pin|MCU_AQS2_CPU_Pin|MCU_AQS1_CPU_Pin
#define GPIOC_DEFAULT_PINSET					MCU_EN_5V_Pin|SYS_RESET_Pin/*DC2DC_EN_Pin*/
...
#define CPU_TXD3_MCU_Pin                      	GPIO_PIN_0
#define CPU_TXD3_MCU_GPIO_Port                	GPIOB
#define MCU_EN_EDLC_Pin                  	    GPIO_PIN_1
#define MCU_EN_EDLC_GPIO_Port	                GPIOB

#define CPU_RXD3_MCU_Pin                      	GPIO_PIN_2
#define CPU_RXD3_MCU_GPIO_Port                	GPIOB
#define PMIC_PG_MCU_Pin							GPIO_PIN_8
#define PMIC_PG_MCU_GPIO_Port					GPIOA
...
#define MCU_EN_PMIC_Pin                  	   	GPIO_PIN_15
#define MCU_EN_PMIC_GPIO_Port           	    GPIOA
#define MCU_AQS3_CPU_Pin                        GPIO_PIN_4
#define MCU_AQS3_CPU_GPIO_Port                  GPIOB
#define MCU_AQS0_CPU_Pin                        GPIO_PIN_5
...
/* MX_GPIO_Init() -> GPIO_PIN_RESET*/
#define GPIOA_DEFAULT_PINSET					MCU_EN_PMIC_Pin|MCU_EN_MCUPWR_Pin|MCU_PWR_RCAM_Pin
#define GPIOB_DEFAULT_PINSET					MCU_AQS0_CPU_Pin|MCU_AQS1_CPU_Pin|MCU_AQS2_CPU_Pin|MCU_EN_CPU_Pin|MCU_EN_EDLC_Pin
#define GPIOC_DEFAULT_PINSET					MCU_EN_5V_Pin|SYS_RESET_Pin
#endif //(__EMT_DEVELOP_STAGE__ == __PROTO__)
